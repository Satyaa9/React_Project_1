  ...
  return (
    <>
      <section className="mt-2 mx-auto">
        <h2
          className="text-3xl font-extrabold text-gray-100 mb-6 tracking-tight
   border-1-4 border-y-amber-400 pl-4 flex items-center"
        >
                ...
                >
                  ...
                  <div className="flex justify-center items-center p-5">
                    <img
                      ...
                      alt=""
                      className="h-[120px] w-[120px] rounded-xl border border-yellow-400 transition duration-500
